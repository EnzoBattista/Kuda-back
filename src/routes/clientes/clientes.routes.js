...
router.get("/:email", auth, requirePermiso(PERMISOS.USUARIO_GESTIONAR), getClienteById);
router.post("/", auth, requirePermiso(PERMISOS.USUARIO_GESTIONAR), createCliente);
router.put("/:email", auth, requirePermiso(PERMISOS.USUARIO_GESTIONAR), updateCliente);
